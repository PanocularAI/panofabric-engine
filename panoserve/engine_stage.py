"""Transitional shim: `python -m panoserve.engine_stage` -> `panoengine.serve.engine_stage`.
...
runpy.run_module("panoengine.serve.engine_stage", run_name="__main__", alter_sys=True)
